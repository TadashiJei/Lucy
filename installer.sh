#!/bin/bash
# Created by Tadashi_Jei
# Actual maintainer: Lucyfer
# Version 0.2
...
echo -e "$blue" "by Tadashi_Jei"
echo -e "$purple" "modified by Lucyfer"
...
install_environment() {
  ...
  ./fluxion.sh
  echo -e "$red" "by Tadashi_Jei"
  echo -e "$purple" "by Tadashi_Jei"
